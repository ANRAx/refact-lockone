        ...
        <div>
            ...
            <article className="pa3 pa5-ns">
                <ul className="list pl0 ml0 center mw4 ba b--white br2 bg-white">
                    <li className="tc mv1 pv3 ba b--black grow pointer bg-green">Lock One</li>
                    <li className="tc mv1 pv3 ba b--black grow pointer bg-yellow">Lock Two</li>
                    <li className="tc mv1 pv3 ba b--black grow pointer bg-orange">Lock Three</li>
                    <li className="tc mv1 pv3 ba b--black grow pointer bg-red">Lock Four</li>
                </ul>
            </article>
        </div>
    );
